...
namespace dersonsena\cadimowebgii\model;

use dersonsena\cadimowebgii\GeneratorAbstract;
use Yii;
...
class Generator extends GeneratorAbstract
{
    ...
    {
        return '[Cadimoweb] - Model Generator';
    }
    ...
    {
        return 'Gerador de Models personalizado para o sistema do Cadimoweb';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [
                ...
                'match',
                'pattern' => '/^\w+$/', 'message' => 'Only word characters are allowed.'
            ],
            [
    ...
    public function stickyAttributes()
    {
        return array_merge(
            ...
            [
                'ns', 'db', 'baseClass', 'generateRelations',
                'generateLabelsFromComments', 'queryNs',
